(function (global, factory) {
    ...
    (global = global || self, factory(global.UniversalRouter = {}));
    ...
    ***************************************************************************** */
    ...
    var pathToRegexp$1 = UniversalRouter.pathToRegexp;
    var cache$1 = new Map();
    ...
    function generateUrls(router, options) {
        ...
        return function (routeName, params) {
            var map = router.routesByName;
            var route = map.get(routeName);
            if (!route) {
...
//# sourceMappingURL=universal-router-generate-urls.umd.js.map
